<template>
  <div class="container">
    ...
    <arrow-box>
      ...
      <div class="sponsor-items co_org">
        <mint-box class="sponsor-item" v-for="item of sponsors.co_org" :id="item.id" :href="item.link">
          ...
          <Markdown class="sponsor-description" :content="item.description" v-if="item.description" />
        </mint-box>
      </div>
    </arrow-box>
    <arrow-box>
    ...
    <arrow-box v-for="data of [...sponsors.sponsors, ...sponsors.thanks, ...sponsors.media_partners]">
