<script lang="ts">
// https://github.com/valgeirb/vue-confetti-explosion/blob/main/src/ConfettiExplosion.vue
...
<template>
  <div v-if="isVisible && isValid" class="container" :style="`--floor-height: ${stageHeight}px;`">
