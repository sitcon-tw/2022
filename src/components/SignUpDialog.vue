  ...
  <ArrowDialog v-model="dialogStore.signUpDialogOpened">
    ...
    <div class="content">
      <p class="text">
        ...
        <ul>
          <li>學生 / 普通票 於 07/16（六）20:00 及 08/06（六）20:00 在 KKTIX 開放報名。</li>
          <li>透過開源貢獻，您也可以直接取得門票，修 code、發 issue 及舉辦開源推廣活動等均能申請，詳細規則請見 OSCVPass 網站，務必在 07/18（一）前送出申請表單。</li>
          <li>偏鄉、離島及海外學生於 7/10（日）前可申請「遠道而來票」，期許能提供偏鄉及離島地區學生接觸資訊領域的機會，也鼓勵國外的學生來台進行交流。</li>
        </ul>
      </p>
      <div class="btns">
