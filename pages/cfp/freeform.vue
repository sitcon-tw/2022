 <template>
  <div class="maze-background">
    ...
    <cfp-glass-box first-child>
      ...
      <p>在追求創新的時代，我們為講者提供了開放式議程這個選項，跳脫講者對聽眾單向的演講（陳述），開放式議程更加強調主講者和與會者的雙向交流。SITCON 作為學生展現自己的舞台，我們期待以學生為主體的投稿，可以是從學生角度出發的經驗分享、技術分享，或是一同探討學生相關議題等。
        <br>
        <br>
...
<script setup>
const title = ref('SITCON 2022 - 開放式議程')
</script>